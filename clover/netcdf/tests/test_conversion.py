...
import numpy
import rasterio
from clover.netcdf.crs import PROJ4_GEOGRAPHIC
from clover.netcdf.conversion import netcdf_to_raster
...
def test_netcdf_to_raster(tmpdir):
    ...
    dataset = Dataset('clover/test_data/tmin.nc')
    varname = 'tmin'
    ...
    with rasterio.open(outfilename, 'r') as src:
        ...
        assert numpy.array_equal(data, src.read_band(1))
